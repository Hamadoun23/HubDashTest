...
export default function Publications() {
  ...
  return (
    <div>
      <PageHeader icon={Megaphone} titre="Publications" sousTitre="Ce qui est publié ou programmé" accent="#e8481b" />

      <div className="grid grid-cols-[1fr_1.6fr] gap-6">
        <Card>
          <div className="flex items-center justify-between">
            <h2 className="text-sm font-bold text-slate-900">{idEnEdition !== null ? 'Modifier la publication' : 'Nouvelle publication'}</h2>
            {idEnEdition !== null && (
          ...
          <form onSubmit={envoyer} className="mt-4 flex flex-col gap-3">
            ...
            {avertissements.length > 0 && (
              <div className="rounded-xl border border-planning-o3/30 bg-planning-o3/10 p-2.5 text-xs text-planning-o3">
        ...
        <div>
          <h2 className="mb-3 text-sm font-bold text-slate-900">Publications</h2>
